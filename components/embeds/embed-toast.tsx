...
export default function EmbedToast() {
  ...
  // if (jwtToken) {
    return (
      <Script
        src="https://cdn.jsdelivr.net/gh/romanyrefaat1/hooklify-widgets@223a8d4a6e883d2a24ba5078a5c779baaf179d36/widgets/toast/toast.js" // ?v=2 to force cache refresh
